...
namespace School_Project
{
    public class Items
    {
        ...
        public Items()
        {
            ...
            ItemsList.Add(new Item("Koskenkorvapullo", "(+Vahinko -Osumatarkkuus)", new Position(0, 0), '!', ConsoleColor.Blue, SoundType.Alcohol, () =>
            {
            ...
            ItemsList.Add(new Item("Välivesi", "(+Osumatarkkuus)", new Position(0, 0), '!', ConsoleColor.Cyan, SoundType.NonAlcohol, () =>
            {
            ...
            ItemsList.Add(new Item("Vissy", "ilman kossua (+Hp +MaxHp)", new Position(0, 0), '!', ConsoleColor.DarkBlue, SoundType.NonAlcohol, () =>
            {
            ...
            ItemsList.Add(new Item("Konjakki", "(+Kokemuspisteet)", new Position(0, 0), '!', ConsoleColor.DarkRed, SoundType.Alcohol, () =>
            {
            ...
            ItemsList.Add(new Item("Smurffilimu", "(+Hp)", new Position(0, 0), '!', ConsoleColor.DarkGreen, SoundType.NonAlcohol, () =>
            {
                gc.Player.HitPoints += 100;
                gc.MessageLog.AddMessage(new LogMessage("Juot smurffilimun ja tunnet voivasi paremmin", ConsoleColor.Blue));
            }));
            ItemsList.Add(new Item("Maitotölkki", "(+raha)", new Position(0, 0), '!', ConsoleColor.White, SoundType.NonAlcohol, () =>
            {
                gc.Player.Money += 5;
