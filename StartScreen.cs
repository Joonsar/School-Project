...
namespace School_Project
{
    ...
    public class StartScreen
    {
        ...
        public void NewGame()
        {
            ...
            Console.WriteLine("            (siinä vasta kunnon mulkku! Hinkkaa bemariaa pihassa ilman paitaa sikspakkiä esitelle ja kehuu kuin on bisnesmies vaikka isin taaloilla\n            tehny vaa tappioo ja sikspäkkiki on silikoonia.)");
